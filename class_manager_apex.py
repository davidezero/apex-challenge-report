...
class ClassificaManager:
    ...
    def genera_report_html(self):
        ...
        aggiungendo il logo Ubroker e le colorazioni aziendali.
        """
        ...
        if not self.dati_collaboratori:
            ...
            for nome, punteggio in classifica_ordinata:
                ...
                # Modifica per mostrare le coppe al posto dei numeri per i primi 3
                if posizione == 1:
        ...
        report_filename = "classifica_apex_report.html"
...
if __name__ == "__main__":
    ...
    URL_REPORT_ONLINE = "https://github.com/davidezero/apex-challenge-report.git" 
    ...
    layout = [
        ...
        [sg.HorizontalSeparator()],
        [sg.Button("Genera Report HTML", key='-REPORT-'), sg.Button("Condividi su WhatsApp", key='-WHATSAPP-'), sg.Button("Esci", key='-ESCI-')]
    ]
